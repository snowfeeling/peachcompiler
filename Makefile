OBJECTS= ./build/compiler.o ./build/cprocess.o ./build/lexer.o ./build/token.o ./build/lex_process.o ./build/parser.o ./build/node.o ./build/scope.o ./build/expressionable.o ./build/datatype.o ./build/helpers/vector.o ./build/helpers/buffer.o  ./build/mytools.o
INCLUDES= -I./

all: $(OBJECTS)
	gcc  main.c $(INCLUDES) $(OBJECTS) -g -o ./main.exe
...
./build/mytools.o: ./mytools.c 
	gcc ./mytools.c $(INCLUDES) -o ./build/mytools.o -g -c
